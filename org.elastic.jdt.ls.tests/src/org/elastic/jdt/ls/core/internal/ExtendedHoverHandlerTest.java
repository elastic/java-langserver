...
import static org.elastic.jdt.ls.core.internal.JsonMessageHelper.getParams;
...
public class ExtendedHoverHandlerTest extends AbstractProjectsManagerBasedTest {
	...
	private ExtendedHoverHandler handler;
	...
	public void setup() throws Exception {
		...
		handler = new ExtendedHoverHandler(preferenceManager);
	}
	...
	public void testHover() throws Exception {
		...
		//when
		Hover hover = handler.extendedHover(position, monitor);
	...
	public void testHoverThrowable() throws Exception {
		...
		Hover hover = handler.extendedHover(params, monitor);
		assertNotNull(hover);
	...
	public void testHoverOnJavadocWithValueTag() throws Exception {
		...
		String content = null;
		assertTrue("javadoc has null content", javadoc != null && javadoc.getLeft() != null && (content = javadoc.getLeft()) != null);
		assertMatches("`\"SimpleStringData\"` is a simple String", content);
	}
	...
	public void testHoverOnJavadocWithLinkToMethodInClass() throws Exception {
		...
		String content = null;
		assertTrue("javadoc has null content", javadoc != null && javadoc.getLeft() != null && (content = javadoc.getLeft()) != null);
		assertMatches("`newMethodBeingLinkedToo`", content);
	}
	...
	public void testHoverOnJavadocWithMultipleDifferentTypesOfTags() throws Exception {
		...
		String expectedJavadoc = "This Javadoc contains a link to `newMethodBeingLinkedToo`\n" + "\n" + " \\*  \\*\\*Parameters:\\*\\*\n" + "    \n"
				+ "     \\*  \\*\\*someString\\*\\* the string to enter\n" + " \\*  \\*\\*Returns:\\*\\*\n" + "    \n" + "     \\*  String\n" + " \\*  \\*\\*Throws:\\*\\*\n" + "    \n" + "     \\*  IOException\n"
				+ " \\*  \\*\\*Since:\\*\\*\n" + "    \n" + "     \\*  0.0.1\n" + " \\*  \\*\\*Version:\\*\\*\n" + "    \n" + "     \\*  0.0.1\n" + " \\*  \\*\\*Author:\\*\\*\n" + "    \n" + "     \\*  jpinkney\n"
				+ " \\*  \\*\\*See Also:\\*\\*\n" + "    \n" + "     \\*  `Online docs for java`";
	...
	public void testHoverOnJava11var() throws Exception {
		...
		//when
		hover = handler.extendedHover(position, monitor);
		assertNotNull(hover);
		assertNotNull(hover.toString(), hover.getContents().getLeft().get(0).getRight());
	...
	private Hover getHover(ICompilationUnit cu, int line, int character) {
		...
		TextDocumentPositionParams position = getParams(payload);
		return handler.extendedHover(position, monitor);
	}
